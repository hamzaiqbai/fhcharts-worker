        ...
        try:
            ...
            cursor.execute("""
                SELECT EXISTS (
                    ...
                    AND table_name = 'timeframe_data'
                );
            """)
            table_exists = cursor.fetchone()[0]
            
            if table_exists:
                logger.info("timeframe_data table already exists, skipping creation")
                
                # Just ensure indexes exist (they're safe to re-create)
                cursor.execute("""
                ...
                CREATE INDEX idx_symbol_timeframe_bucket 
                ON timeframe_data(symbol, timeframe, bucket);
                ...
                logger.info("Created new timeframe_data table")
